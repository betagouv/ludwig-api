...
module.exports = function(api) {
    ...
    */
    ...
    api.route('/acceptance-tests/possibles-values')
        .get(acceptanceTests.possibleValues);

    api.route('/acceptance-tests/launch-all')
        .all(auth.ensureLoggedIn)
        .get(acceptanceTests.launchAll);
    ...
    api.route('/acceptance-tests/:testId/simulation')
        .all(auth.ensureLoggedIn)
        .post(acceptanceTests.simulate);
    ...
    api.route('/public/acceptance-tests')
        .all(cors())
        .get(acceptanceTests.listPublic)
        .post(acceptanceTests.createPublic);
};
